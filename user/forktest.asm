...
void forktest(void)
{
  ...
  3e:	43e50513          	addi	a0,a0,1086 # 478 <sysinfo+0xa>
  ...
  68:	42450513          	addi	a0,a0,1060 # 488 <sysinfo+0x1a>
  ...
  b8:	42450513          	addi	a0,a0,1060 # 4d8 <sysinfo+0x6a>
  ...
  d4:	3d850513          	addi	a0,a0,984 # 4a8 <sysinfo+0x3a>
  ...
  ee:	3d650513          	addi	a0,a0,982 # 4c0 <sysinfo+0x52>
