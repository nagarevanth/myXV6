...
int main(int argc, char* argv[])
{
  ...
  2c:	35e080e7          	jalr	862(ra) # 386 <setpriority>
...
putc(int fd, char c)
{
 ...
 3ac:	f3e080e7          	jalr	-194(ra) # 2e6 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	43e50513          	addi	a0,a0,1086 # 818 <digits>
 3e2:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4aa:	372b8b93          	addi	s7,s7,882 # 818 <digits>
 ...
 5ea:	22a90913          	addi	s2,s2,554 # 810 <malloc+0xe4>
        while (*s != 0)
...
malloc(uint nbytes)
{
 ...
 804:	b4e080e7          	jalr	-1202(ra) # 34e <sbrk>
  if (p == (char *)-1)
