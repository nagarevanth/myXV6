...
void print_sysmem(char *label) {
   ...
   a:	84aa                	mv	s1,a0
    struct sysinfo info;
    sysinfo(&info);
   c:	fc840513          	addi	a0,s0,-56
  10:	00000097          	auipc	ra,0x0
  14:	458080e7          	jalr	1112(ra) # 468 <sysinfo>
    printf("%s:\n", label);
  18:	85a6                	mv	a1,s1
  1a:	00001517          	auipc	a0,0x1
  1e:	8d650513          	addi	a0,a0,-1834 # 8f0 <malloc+0xea>
  22:	00000097          	auipc	ra,0x0
  26:	726080e7          	jalr	1830(ra) # 748 <printf>
    printf("  Total: %d KB\n", (int)(info.total / 1024));
  2a:	fc843583          	ld	a1,-56(s0)
  2e:	81a9                	srli	a1,a1,0xa
  30:	2581                	sext.w	a1,a1
  32:	00001517          	auipc	a0,0x1
  36:	8c650513          	addi	a0,a0,-1850 # 8f8 <malloc+0xf2>
  3a:	00000097          	auipc	ra,0x0
  3e:	70e080e7          	jalr	1806(ra) # 748 <printf>
    printf("  Used : %d KB\n", (int)(info.used / 1024));
  42:	fd843583          	ld	a1,-40(s0)
  46:	81a9                	srli	a1,a1,0xa
  48:	2581                	sext.w	a1,a1
  4a:	00001517          	auipc	a0,0x1
  4e:	8be50513          	addi	a0,a0,-1858 # 908 <malloc+0x102>
  52:	00000097          	auipc	ra,0x0
  56:	6f6080e7          	jalr	1782(ra) # 748 <printf>
    printf("  Free : %d KB\n", (int)(info.free / 1024));
  5a:	fd043583          	ld	a1,-48(s0)
  5e:	81a9                	srli	a1,a1,0xa
  60:	2581                	sext.w	a1,a1
  62:	00001517          	auipc	a0,0x1
  66:	8b650513          	addi	a0,a0,-1866 # 918 <malloc+0x112>
...
int main(int argc, char *argv[]) {
  ...
  8a:	8a250513          	addi	a0,a0,-1886 # 928 <malloc+0x122>
  8e:	00000097          	auipc	ra,0x0
  92:	f72080e7          	jalr	-142(ra) # 0 <print_sysmem>

    char *buf = sbrk(16 * 1024 * 1024);  // allocate 16MB
  96:	01000537          	lui	a0,0x1000
  9a:	00000097          	auipc	ra,0x0
  9e:	38e080e7          	jalr	910(ra) # 428 <sbrk>
  a2:	84aa                	mv	s1,a0
    for (int i = 0; i < 16 * 1024 * 1024; i += 4096)
  a4:	87aa                	mv	a5,a0
  a6:	01000737          	lui	a4,0x1000
  aa:	972a                	add	a4,a4,a0
  ac:	6685                	lui	a3,0x1
        buf[i] = 0;
  ae:	00078023          	sb	zero,0(a5)
    for (int i = 0; i < 16 * 1024 * 1024; i += 4096)
  b2:	97b6                	add	a5,a5,a3
  b4:	fee79de3          	bne	a5,a4,ae <main+0x32>

    print_sysmem("After allocation");
  b8:	00001517          	auipc	a0,0x1
  bc:	88850513          	addi	a0,a0,-1912 # 940 <malloc+0x13a>
  c0:	00000097          	auipc	ra,0x0
  c4:	f40080e7          	jalr	-192(ra) # 0 <print_sysmem>

    int pid = fork();
  c8:	00000097          	auipc	ra,0x0
  cc:	2d0080e7          	jalr	720(ra) # 398 <fork>
    if (pid == 0) {
  d0:	e115                	bnez	a0,f4 <main+0x78>
        // Child process
        buf[0] = 42; // maybe write to trigger COW
  d2:	02a00793          	li	a5,42
  d6:	00f48023          	sb	a5,0(s1)
        print_sysmem("Child after write");
  da:	00001517          	auipc	a0,0x1
  de:	87e50513          	addi	a0,a0,-1922 # 958 <malloc+0x152>
  e2:	00000097          	auipc	ra,0x0
  e6:	f1e080e7          	jalr	-226(ra) # 0 <print_sysmem>
        exit(0);
  ea:	4501                	li	a0,0
  ec:	00000097          	auipc	ra,0x0
  f0:	2b4080e7          	jalr	692(ra) # 3a0 <exit>
    } else {
        wait(0);
  f4:	4501                	li	a0,0
  f6:	00000097          	auipc	ra,0x0
  fa:	2b2080e7          	jalr	690(ra) # 3a8 <wait>
    }

    print_sysmem("Parent after fork");
  fe:	00001517          	auipc	a0,0x1
 102:	87250513          	addi	a0,a0,-1934 # 970 <malloc+0x16a>
 106:	00000097          	auipc	ra,0x0
 10a:	efa080e7          	jalr	-262(ra) # 0 <print_sysmem>
    exit(0);
 10e:	4501                	li	a0,0
...
void _main()
{
 ...
 124:	f5c080e7          	jalr	-164(ra) # 7c <main>
  exit(0);
 128:	4501                	li	a0,0
...
int atoi(const char *s)
{
 ...
 2d0:	fd07851b          	addiw	a0,a5,-48
  while ('0' <= *s && *s <= '9')
 2d4:	0006c603          	lbu	a2,0(a3) # 1000 <freep>
...
memmove(void *vdst, const void *vsrc, int n)
{
 ...
 30e:	fed70fa3          	sb	a3,-1(a4) # ffffff <base+0xffefef>
    while (n-- > 0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4b8:	4dc50513          	addi	a0,a0,1244 # 990 <digits>
 4bc:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 584:	410b8b93          	addi	s7,s7,1040 # 990 <digits>
 ...
 6c4:	2c890913          	addi	s2,s2,712 # 988 <malloc+0x182>
        while (*s != 0)
