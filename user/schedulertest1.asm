  ...
  18:	49a9                	li	s3,10
{
  ...
  40:	88450513          	addi	a0,a0,-1916 # 8c0 <malloc+0xf2>
  ...
  62:	88250513          	addi	a0,a0,-1918 # 8e0 <malloc+0x112>
  ...
  90:	83c50513          	addi	a0,a0,-1988 # 8c8 <malloc+0xfa>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 480:	48c50513          	addi	a0,a0,1164 # 908 <digits>
 484:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54c:	3c0b8b93          	addi	s7,s7,960 # 908 <digits>
 ...
 68c:	27890913          	addi	s2,s2,632 # 900 <malloc+0x132>
        while (*s != 0)
